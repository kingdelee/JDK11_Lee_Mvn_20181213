...
public final class TimeUtil {
     ...
     * @param pattern 日期格式
     * @return 格式化后的字符串
     * @throws NullPointerException     如果参数date为null 或 参数pattern为null
     * @throws IllegalArgumentException 如果参数pattern无效
     */
     ...
     * @throws NullPointerException     如果参数dateStr为null 或 参数pattern为null
     * @throws IllegalArgumentException 如果参数pattern无效
     * @throws ParseException           如果转化失败
     */
     ...
     * @throws NullPointerException     如果参数pattern为null
     * @throws IllegalArgumentException 如果参数pattern无效
     */
