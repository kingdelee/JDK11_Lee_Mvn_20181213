 ...
 * <p>
 * 注：这里说它是线程安全是不对的，它是线程不安全的 证明见：
 * {@link C4_composing_objects.Ch4_16_Implementing_put_if_absent_using_composition.ImprovedListTest}
 *
...
public class ImprovedList<T> implements List<T> {
    ...
    public synchronized boolean putIfAbsent(T x) {
        ...
        if (contains) // <= 逻辑错误 应该为 if (!contains)
            list.add(x);
        return !contains;
    }
