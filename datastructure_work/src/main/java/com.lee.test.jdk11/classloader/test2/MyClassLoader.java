...
//        String desPath = args[1];//ClassLoaderAttachment.class输出的路径
        ...
        srcPath = "/Users/kingdelee/IdeaProjects/Jdk11_Lee_Mvn_Project/target/classes/com/lee/test/jdk11/classloader/test2/ClassLoaderAttachment.class";
        desPath = "";
        ...
        System.out.println(desPathFile);
